...
use Hegyd\News\Controllers\AbstractController;
use Hegyd\News\Controllers\Traits\Configurable;
use App\Http\Controllers\Traits\Datatable;
use App\Http\Controllers\Traits\Formable;
use Hegyd\News\Repositories\Contracts\RepositoryInterface;
...
abstract class AbstractBackendController extends AbstractController
{
    ...
    protected function defaults()
    {
        return [
            ...
            'rows_actions_template'  => '/hegyd-news::backend.includes.datatable.default_actions',

            // use / for indicate to the Configurable Trait that this path don't need to be prefixed with prefixes['view']
            'rows_checkbox_template' => '/hegyd-news::backend.includes.datatable.default_checkbox',
            ...
            'views'                  => [
                ...
                'index'  => '/hegyd-news::backend.includes.datatable.default_index',
    ...
    protected function configureBreadcrumb()
    {
        ...
        $config['namespace'] = config('hegyd-news.view-namespace.backend');
