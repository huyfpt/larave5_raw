...
class UsersController extends AbstractExtranetController
{

    use Uploadable, Formable, Configurable, Apiable;
    ...
    public function myProfile()
    {
        ...
        return view('app.contents.extranet.users.my_profile', compact('title', 'user'));
    }
    ...
    public function myProfileUpdate()
    {
        ...
        if ($validator->fails())
        {
            return $this->redirectError(route('extranet.users.my_profile'), $validator);
        } else
        {
            ...
            return redirect()->route('extranet.users.my_profile');
        }
    }
