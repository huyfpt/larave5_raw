...
{!! Html::style('/vendor/hegyd/ecommerce/dependencies/nestable/nestable.css') !!}
@endpush
@push('scripts')
...
{!! Html::script('/vendor/hegyd/ecommerce/dependencies/nestable/jquery.nestable.js') !!}

{!! Html::script('/vendor/hegyd/ecommerce/js/notifications.js') !!}
{!! Html::script('/vendor/hegyd/ecommerce/js/categories/tree.js') !!}
@endpush