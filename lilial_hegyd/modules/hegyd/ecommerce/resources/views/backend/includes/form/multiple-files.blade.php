...
@push('scripts')
    ...
    {!! Html::script('/vendor/hegyd/ecommerce/dependencies/bootstrap-fileinput/js/fileinput.js') !!}
    {!! Html::script('/vendor/hegyd/ecommerce/dependencies/bootstrap-fileinput/js/plugins/sortable.js') !!}
    {!! Html::script('/vendor/hegyd/ecommerce/dependencies/bootstrap-fileinput/js/locales/fr.js') !!}

    {!! Html::script('/vendor/hegyd/ecommerce/js/multiple-file-input.js') !!}
@endpush