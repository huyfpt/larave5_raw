<?php namespace Hegyd\Pages\Controllers\Backend;

use App\Http\Controllers\Traits\Apiable;
use Hegyd\Pages\Controllers\AbstractController;
use Hegyd\Pages\Controllers\Traits\Configurable;
use Hegyd\Pages\Controllers\Traits\Datatable;
use Hegyd\Pages\Controllers\Traits\Formable;
use Hegyd\Pages\Repositories\Contracts\RepositoryInterface;
use Illuminate\Http\Request;

/**
 * Class AbstractBackendController
 * @package Hegyd\Pages\Controllers\Backend
 */
abstract class AbstractBackendController extends AbstractController
{
    ...
    protected function defaults()
    {
        return [
            ...
            'rows_actions_template'  => '/hegyd-pages::backend.includes.datatable.default_actions',

            // use / for indicate to the Configurable Trait that this path don't need to be prefixed with prefixes['view']
            'rows_checkbox_template' => '/hegyd-pages::backend.includes.datatable.default_checkbox',
            ...
            'views'                  => [
                ...
                'index'  => '/hegyd-pages::backend.includes.datatable.default_index',
    ...
    protected function configureBreadcrumb()
    {
        ...
        $config['namespace'] = config('hegyd-pages.view-namespace.backend');
    ...
    protected function createBreadCrumb()
    {
        ...
        // $this->breadcrumbs->addCrumb(trans('hegyd-pages::pages.title.index'));
        $title = $this->title;
