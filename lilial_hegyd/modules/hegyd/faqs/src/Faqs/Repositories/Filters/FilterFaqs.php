<?php
namespace Hegyd\Faqs\Repositories\Filters;
...
class FilterFaqs
{
    ...
    public function getEntityChildrenQuery($role_id, $more_datas, $query)
    {
        if ($role_id != 0)
        {
            app(config('hegyd-faqs.filters.faqs'))->getAllFaqs($role_id, $more_datas, $query);
        }
    }
    public function getAllFaqsQuery($faqs, $role_id, $more_datas)
    {
        if ($role_id != 0)
            app(config('hegyd-faqs.filters.faqs'))->getAllFaqs($role_id, $more_datas, $faqs);
    }
    /**
    ...
    public function getAllFaqs($role_id, $more_datas, $query)
    {
    ...
    public function canShow($faqs, $role_id, $more_datas)
    {
        return true;
    }
}