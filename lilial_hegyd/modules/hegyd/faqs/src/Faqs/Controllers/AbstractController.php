<?php
namespace Hegyd\Faqs\Controllers;

use Hegyd\Faqs\Controllers\Traits\Breadcrumbable;
use Hegyd\Faqs\Services\NotificationService;
 ...
 * @package Hegyd\Faqs\Controllers
 */
