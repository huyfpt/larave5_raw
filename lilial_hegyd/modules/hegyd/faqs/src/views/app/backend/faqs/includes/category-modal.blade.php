...
<div class="modal fade" id="modal-category" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {!! Form::model($category, ['route' => config('hegyd-faqs.routes.backend.faqs_category.create-from-modal'), 'method' => 'post', 'class' => 'form-horizontal']) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">@lang('hegyd-faqs::faqs_categories.title.new')</h4>
            </div>
            <div class="modal-body">
                <div class="form-group {!! Form::hasError('active', $errors) !!}">
                    <div class="col-md-2">
                        <label class="control-label">@lang('hegyd-faqs::faqs_categories.field.active')</label>
                    </div>
                    <div class="col-md-10">
                ...
                <div class="form-group {!! Form::hasError('name', $errors) !!}">
                    <div class="col-md-2">
                        <label class="control-label">@lang('hegyd-faqs::faqs_categories.field.name') <i class="required-field">*</i></label>
                    </div>
                    <div class="col-md-10">
