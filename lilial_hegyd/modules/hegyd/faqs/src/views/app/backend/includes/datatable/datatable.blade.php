...
@push('stylesheets')
{!! Html::style('/vendor/hegyd/faqs/dependencies/datatables.net-dt/css/jquery.dataTables.min.css') !!}
{!! Html::style('/vendor/hegyd/faqs/dependencies/datatables.net-fixedheader-dt/css/fixedHeader.dataTables.min.css') !!}
{!! Html::style('/vendor/hegyd/faqs/dependencies/datatables.net-responsive-dt/css/responsive.dataTables.min.css') !!}
...
@push('scripts')
{!! Html::script('/vendor/hegyd/faqs/dependencies/datatables.net/js/jquery.dataTables.min.js') !!}
{!! Html::script('/vendor/hegyd/faqs/dependencies/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js') !!}
{!! Html::script('/vendor/hegyd/faqs/dependencies/datatables.net-responsive/js/dataTables.responsive.min.js') !!}

{!! Html::script('/vendor/hegyd/faqs/dependencies/bootstrap-datepicker/dist/js/bootstrap-datepicker.js') !!}
...
{!! Html::script('/vendor/hegyd/faqs/js/datatable/datatable.js') !!}
@endpush
