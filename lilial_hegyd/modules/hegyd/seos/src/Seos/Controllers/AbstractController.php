<?php namespace Hegyd\Seos\Controllers;

use Hegyd\Seos\Controllers\Traits\Breadcrumbable;
use Hegyd\Seos\Services\NotificationService;
 ...
 * @package Hegyd\Seos\Controllers
 */
