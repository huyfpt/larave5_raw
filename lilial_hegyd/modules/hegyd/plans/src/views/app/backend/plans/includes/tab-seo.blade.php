<div class="white-box">
    <div class="form-group {!! Form::hasError('meta_title', $errors) !!}">
        <div class="col-md-2">
            <label class="control-label">@lang('hegyd-plans::plans.field.meta_title') <i class="required-field">*</i></label>
        </div>
        <div class="col-md-10">
    ...
    <div class="form-group {!! Form::hasError('meta_description', $errors) !!}">
        <div class="col-md-2">
            <label class="control-label">@lang('hegyd-plans::plans.field.meta_description') <i class="required-field">*</i></label>
        </div>
        <div class="col-md-10">
    ...
    <div class="form-group {!! Form::hasError('meta_keyword', $errors) !!}">
        <div class="col-md-2">
            <label class="control-label">@lang('hegyd-plans::plans.field.meta_keyword')</label>
        </div>
        <div class="col-md-10">
    ...
    <div class="form-group {!! Form::hasError('meta_robots', $errors) !!}">
        <div class="col-md-2">
            <label class="control-label">@lang('hegyd-plans::plans.field.meta_robots')</label>
        </div>
        <div class="col-md-10">
            {!! Form::select('meta_robots', $plansService->metaRobots(), $model->meta_robots, ['class' => 'form-control']) !!}
