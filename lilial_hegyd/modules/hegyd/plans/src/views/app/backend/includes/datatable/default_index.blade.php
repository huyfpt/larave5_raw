                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                @include('hegyd-plans::backend.includes.datatable.datatable')
                            </div>
                        </div>
                    </div>
...
@endsection
@push('stylesheets')
{!! Html::style('/vendor/hegyd/plans/dependencies/sweetalert/dist/sweetalert.css') !!}
{!! Html::style('/vendor/hegyd/plans/dependencies/toastr/toastr.min.css') !!}
@endpush
@push('scripts')
{!! Html::script('/vendor/hegyd/plans/dependencies/sweetalert/dist/sweetalert.min.js') !!}
{!! Html::script('/vendor/hegyd/plans/dependencies/toastr/toastr.min.js') !!}

{!! Html::script('/vendor/hegyd/plans/js/notifications.js') !!}
{!! Html::script('/vendor/hegyd/plans/js/datatable/default.js') !!}
{!! Html::script('/vendor/hegyd/plans/js/datatable/bulk_actions.js') !!}
@endpush
