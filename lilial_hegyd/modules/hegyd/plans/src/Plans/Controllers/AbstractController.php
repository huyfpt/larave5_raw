<?php namespace Hegyd\Plans\Controllers;

use Hegyd\Plans\Controllers\Traits\Breadcrumbable;
use Hegyd\Plans\Services\NotificationService;
 ...
 * @package Hegyd\Plans\Controllers
 */
