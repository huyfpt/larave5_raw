...
use Hegyd\Plans\Controllers\AbstractController;
use Hegyd\Plans\Controllers\Traits\Configurable;
use Hegyd\Plans\Controllers\Traits\Datatable;
use Hegyd\Plans\Controllers\Traits\Formable;
use Hegyd\Plans\Repositories\Contracts\RepositoryInterface;
...
abstract class AbstractBackendController extends AbstractController
{
    ...
    protected function defaults()
    {
        return [
            ...
            'rows_actions_template'  => '/hegyd-plans::backend.includes.datatable.default_actions',

            // use / for indicate to the Configurable Trait that this path don't need to be prefixed with prefixes['view']
            'rows_checkbox_template' => '/hegyd-plans::backend.includes.datatable.default_checkbox',
            ...
            'views'                  => [
                ...
                'index'  => '/hegyd-plans::backend.includes.datatable.default_index',
    ...
    protected function configureBreadcrumb()
    {
        ...
        $config['namespace'] = config('hegyd-plans.view-namespace.backend');
    ...
    protected function createBreadCrumb()
    {
        ...
        // $this->breadcrumbs->addCrumb(trans('hegyd-plans::plans.title.index'), route(config('hegyd-plans.routes.backend.plans.index')));
        $title = $this->title;
