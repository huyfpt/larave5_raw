...
<head>
    ...
    @include('hegyd-news::emails.includes.stylesheets')
</head>
                                    ...
                                    <table width="528" border="0" align="center" cellpadding="0" cellspacing="0" class="mainContent">
                                        <tr>
                                            <td class="main-header" style="color: #555555; font-size: 24px; font-weight: normal; font-family: Tahoma, Arial, sans-serif;">
                                                <singleline>
                                                    @yield('welcome', isset($user) ? trans('hegyd-news::emails.global.welcome', ['fullname' => $user->fullname()]) : trans('hegyd-news::emails.global.welcome_short'))
                                                </singleline>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <img style="display: block;"
                                                     src="{{url(config('hegyd-news.directories.assets') . '/img/emails/sep.jpg')}}"
                                            ...
                                            <tr class="button">
                                                <td>
                                                    <a href="@yield('link')" title="" style="display: block; width: 228px; border-style: none !important; border: 0 !important;">
                                                        <img style="display: block;"
                                                             src="{{url(config('hegyd-news.directories.assets') . '/img/emails/btn-interface.png' )}}"
                                        ...
                                        <tr>
                                            <td style="color: #888888; font-size: 15px; line-height: 15px; font-weight: normal; font-family: Tahoma, Arial, sans-serif;">
                                                <multiline>
                                                    @lang('hegyd-news::emails.global.footer', ['site_domain' => url('/'), 'site_name' => config('app.name')])
                                                </multiline>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container">
                <tr>
                    <td style="line-height: 10px;">
                        <img style="display: block;"
                             src="{{url(config('hegyd-news.directories.assets') . '/img/emails/bottom-footer-bg.png')}}"
                             alt="" class="header-bg" />
                    </td>
                </tr>
                <tr><td height="25"></td></tr>
