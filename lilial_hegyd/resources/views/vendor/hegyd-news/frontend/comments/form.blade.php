...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">@lang('hegyd-news::comments.title.new')</h4>
</div>
        ...
        <div class="col-md-12">
            <div class="form-group {!! Form::hasError('name', $errors) !!}">
                <label class="col-md-3">
                    <label class="control-label">@lang('hegyd-news::comments.fields.name')</label>
            ...
            <div class="form-group {!! Form::hasError('content', $errors) !!}">
                <label class="col-md-3">
                    <label class="control-label">@lang('hegyd-news::comments.fields.content')</label>
                    <i class="required-field">*</i>
                </label>
                <div class="col-md-9">
