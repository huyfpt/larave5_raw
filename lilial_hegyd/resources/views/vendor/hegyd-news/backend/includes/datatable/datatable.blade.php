<table id="app-datatable" class="table table-striped table-bordered table-hover dataTable dt-responsive">
    <thead>
        <tr role="row" class="heading">
            ...
            @foreach ($fields as $field)
                <th data-class-row="{!! isset($field['class_row']) ? $field['class_row'] : '' !!}"
                    ...
                    data-field-key="{{$loop->index}}"
                    {{isset($field['order_default']) ? 'data-order=' . $field['order_default'] : ''}}
                >
                    @lang($field['title'])
                </th>
            @endforeach
...
@push('stylesheets')
{!! Html::style('/vendor/bower/datatables.net-dt/css/jquery.dataTables.min.css') !!}
{!! Html::style('/vendor/bower/datatables.net-fixedheader-dt/css/fixedHeader.dataTables.min.css') !!}
{!! Html::style('/vendor/bower/datatables.net-responsive-dt/css/responsive.dataTables.min.css') !!}

{!! Html::style('/vendor/bower/select2/dist/css/select2.min.css') !!}

{!! Html::style('/vendor/bower/bootstrap-datepicker/dist/css/bootstrap-datepicker3.min.css') !!}

@endpush

@push('scripts')
{!! Html::script('/vendor/bower/datatables.net/js/jquery.dataTables.min.js') !!}
{!! Html::script('/vendor/bower/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js') !!}
{!! Html::script('/vendor/bower/datatables.net-responsive/js/dataTables.responsive.min.js') !!}
...
{!! Html::script('/app/js/datatable/datatable-new.js') !!}
@endpush
