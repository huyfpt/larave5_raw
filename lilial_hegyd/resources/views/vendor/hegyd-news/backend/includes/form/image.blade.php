...
@push('stylesheets')
{!! Html::style('/vendor/hegyd/news/dependencies/bootstrap-fileinput/css/fileinput.min.css') !!}
@endpush
@push('scripts')
{!! Html::script('/vendor/hegyd/news/dependencies/bootstrap-fileinput/js/fileinput.min.js') !!}
{!! Html::script('/vendor/hegyd/news/dependencies/bootstrap-fileinput/js/locales/fr.js') !!}

{!! Html::script('/vendor/hegyd/news/js/file-input.js') !!}
@endpush