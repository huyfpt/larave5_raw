<div class="blk-slider blk-banner"><img src="{{ asset('front/uploads/prod-banner.png') }}" alt="">
  ...
  <div class="blk-banner-info">
    <div class="breadcrumb-wrap">
      <div class="container"><a href="{{ url('/') }}">Accueil</a><a href="{{ url('club') }}">Club Lilial</a><span>Liste de ambassadeurs</span></div>
    </div>
    <!-- END : BREADCRUMB-->
    <h1 class="banner-ttl">Liste de ambassadeurs</h1>
  </div>
</div>