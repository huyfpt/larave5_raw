<div class="blk-slider blk-banner"><img src="{{ asset('front/uploads/prod-banner.png') }}" alt="">
  ...
  <div class="blk-banner-info">
    <div class="breadcrumb-wrap">
      <div class="container"><a href="{{ url('/') }}">Accueil </a><a href="{{ url('/club') }}">Club Lilial </a><a href="{{ url('/club/news') }}">Communauté </a><span>{{ $news->name }}</span></div>
    </div>
    <!-- END : BREADCRUMB-->
    <h1 class="banner-ttl">{{ $news->name }}</h1>
  </div>
</div>